...
More generally, these are fundamental and ubiquitous programming concepts.
...
## Bonus: Where does a variable name end?
...
:::{.callout-note collapse="true"}
## Bonus: Quoting as "escaping" special meaning -- and double vs. single quotes
