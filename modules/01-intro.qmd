...
4. **Submit these scripts** to a supercomputer's "queue" and monitor
   and manage the resulting "batch jobs"
...
- Whenever you have a **question**,
  ...
  signal to Mike (Columbus) or Menuka (Wooster) tat you have a question,
  who will unmute.
