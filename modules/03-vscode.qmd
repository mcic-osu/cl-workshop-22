...
<p align="center">
<img src=img/vscode-welcome_ed.png width="100%">
</p>
...
- A bunch of icons in the middle that serve to switch between
  different options for the **Primary (wide) side bar**,
...
(or <kbd>Ctrl</kbd>/<kbd>⌘</kbd>+<kbd>B</kbd> for the Primary Side Bar).
...
VS Code takes a specific folder (directory) as a 
...
In this workshop, we'll work exclusively within the folder
`/fs/ess/scratch/PAS2250`.
We selected this folder already in the form on the OnDemand site,
but you can also switch folders within VS Code  
...
- *Toggle the primary (wide) side bar*: <kbd>Ctrl</kbd>+<kbd>B</kbd> 
