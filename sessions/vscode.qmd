...
In this session, we will learn the basics of a fancy text editor called
...
In the previous session, we've learned that all serious computation at OSC
...
By default, no terminal is opened in VS Code --
to do so, click the
...
In the next session, Mike will teach us how to use the terminal.
...
To switch to a different folder from within the program, click 
