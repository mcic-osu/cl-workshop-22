...
In this module, we will cover several topics you need to know about
before you can start writing and running shell scripts:
variables, `for` loops, and conditionals
(`if` constructs).
...
Here is why you will learn the following concepts and constructs,
and how to use them:

- Using **variables** will allow you to run scripts flexibly,
  with different input files and settings 

- **`for` loops** will allow you to repeat operations --
  specifically, we will later use them to submit many scripts at the same time,
  one per input file or sample.
  
- **"conditionals"**, namely the `if` construct,
  will allow you to perform operations only if a specific condition is met.
  This can also make your scripts flexible,
  and help you to test your input and check your output.
...
Single vs double quotes -- as an exercise?
